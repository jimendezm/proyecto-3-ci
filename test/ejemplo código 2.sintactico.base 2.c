 ...
 let string _s1_$
 int principal є int arg э  ¿ | semantico tipo int, sintactico?
	_arr_[67+_i_++] = -0.01$  | semantico
...
float _mi_  є int _dif_, char _otra_  ¿  |sintactico  э 
	let int _otra_$
	...
	for  _i_=20 step -2 downto 0 do  | puede dar sintactico
	 ¿ 
		...
		exit when є _var2_>12.2 @ Σ є12> є 34+35 ээ  э $ |semantico
		end loop$
		else ->  ¿  | sintactico
			input є _var2_ э $
			break$
